    ...
    public function enqueue_assets() {
        ...
        wp_localize_script('ab2b-portal', 'ab2b_portal', [
            ...
            'strings'    => [
                ...
                'pickup_any_day'        => __('Ready for pick up from the selected date. First availability is next Friday.', 'artisan-b2b-portal'),
                'pickup_from_friday'    => __('Pickup is available from the next Friday. Please select a valid date.', 'artisan-b2b-portal'),
