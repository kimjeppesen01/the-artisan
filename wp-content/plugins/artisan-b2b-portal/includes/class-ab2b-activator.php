...
class AB2B_Activator {
    ...
    private static function create_tables() {
        ...
        $sql_customers = "CREATE TABLE {$table_customers} (
            ...
            cvr_number VARCHAR(255) DEFAULT '',
            delivery_company VARCHAR(255) DEFAULT '',
            delivery_contact VARCHAR(255) DEFAULT '',
            delivery_address TEXT,
            delivery_city VARCHAR(255) DEFAULT '',
            delivery_postcode VARCHAR(255) DEFAULT '',
