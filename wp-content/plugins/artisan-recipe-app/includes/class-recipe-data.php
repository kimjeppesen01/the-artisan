...
class SARA_Recipe_Data {
        ...
        return [
            ...
            'espresso' => [
                ...
                'params' => [
                    ...
                    [ 'value' => 'Fin',    'da' => 'Kværning',   'en' => 'Grind' ],
                ...
                'steps' => [
                    [
                        ...
                        'desc_da'  => 'Skyl portafilteret og koppen med varmt vand. Tøm begge dele og tør efter.',
                    ...
                    [
                        ...
                        'desc_da'  => 'Mal 18g kaffe direkte i portafilteret. Fordel jævnt og tamp med fast, helt lige tryk.',
                        'desc_en'  => 'Grind 18g coffee directly into the portafilter. Distribute evenly and tamp with firm, level pressure.',
                        'time'     => 0,
                    ],
                    [
                        'title_da' => 'Indsæt og start',
                        'title_en' => 'Insert and start',
                        'desc_da'  => 'Sæt portafilteret i gruppen og start ekstraktion med det samme.',
                    ...
                    [
                        ...
                        'title_en' => 'Extraction',
                        'desc_da'  => 'Mål 36g i koppen på 25-30 sekunder. Juster kværning hvis nødvendigt.',
                    ...
                    [
                        ...
                        'desc_da'  => 'Server med det samme. Skummet skal være gyldent.',
                        'desc_en'  => 'Serve immediately. The crema should be golden.',
                        'time'     => 0,
                    ],
                ],
                'tip_da' => 'Hvis dit skud løber for hurtigt (under 20s), gå finere. For langsomt (over 35s), gå grovere. Juster altid én variabel ad gangen.',
            ...
            'pourover' => [
                ...
                'params' => [
                    ...
                    [ 'value' => 'Medium-fin',  'da' => 'Kværning',   'en' => 'Grind' ],
                ...
                'steps' => [
                    [
                        ...
                        'desc_da'  => 'Placer filteret i dripper og skyl med varmt vand. Tøm karaflen.',
                        'desc_en'  => 'Place the filter in the dripper and rinse with hot water. Empty the carafe.',
                        'time'     => 0,
                    ],
                    [
                        'title_da' => 'Tilføj kaffe',
                        'title_en' => 'Add coffee',
                        'desc_da'  => 'Mal 15g kaffe (medium-fin) og hæld i filteret. Ryst let for jævn fordeling.',
                    ...
                    [
                        'title_da' => 'Bloom',
                        'title_en' => 'Bloom',
                        'desc_da'  => 'Hæld 30g vand over kaffen i cirkulære bevægelser. Vent 30-45 sekunder.',
                    ...
                    [
                        'title_da' => 'Hæld vand',
                        'title_en' => 'Pour water',
                        'desc_da'  => 'Hæld resten af vandet (240g total) i langsomme, cirkulære bevægelser over 1-2 minutter.',
                    ...
                    [
                        ...
                        'desc_da'  => 'Lad alt vandet løbe igennem. Total tid: 2:30-3:00. Fjern dripper og server.',
                        'desc_en'  => 'Let all the water drain through. Total time: 2:30-3:00. Remove dripper and serve.',
                        'time'     => 0,
                    ],
                ],
                'tip_da' => 'En god bloom er nøglen til jævn ekstraktion. Kaffen skal boble og udvide sig. Hvis den ikke bobler, er kaffen sandsynligvis for gammel.',
            ...
            'aeropress' => [
                ...
                'params' => [
                    [ 'value' => '15g',      'da' => 'Dosis',      'en' => 'Dose' ],
                    [ 'value' => 'Medium',   'da' => 'Kværning',   'en' => 'Grind' ],
                ...
                'steps' => [
                    [
                        ...
                        'desc_da'  => 'Sæt stemplet i bunden og vend Aeropress på hovedet. Skyl med varmt vand.',
                        'desc_en'  => 'Insert the plunger at the bottom and flip the AeroPress upside down. Rinse with hot water.',
                        'time'     => 0,
                    ],
                    [
                        'title_da' => 'Tilføj kaffe og vand',
                        'title_en' => 'Add coffee and water',
                        'desc_da'  => 'Mal 15g kaffe (medium). Hæld 180g vand ved 85-90°C.',
                        'desc_en'  => 'Grind 15g coffee (medium). Pour 180g water at 85-90°C.',
                        'time'     => 0,
                    ],
                    [
                        'title_da' => 'Rør og steep',
                        'title_en' => 'Stir and steep',
                        'desc_da'  => 'Rør forsigtigt 3-4 gange. Sæt filteret på og lad trække i 1 minut.',
                    ...
                    [
                        ...
                        'desc_da'  => 'Vend forsigtigt over koppen. Pres langsomt og jævnt ned i 20-30 sekunder.',
                    ...
                    [
                        'title_da' => 'Server',
                        'title_en' => 'Serve',
                        'desc_da'  => 'Stop når du hører en hvæsende lyd. Nyd din kaffe ren eller tilsat lidt varmt vand.',
                        'desc_en'  => 'Stop when you hear a hissing sound. Enjoy your coffee black or add a little hot water.',
                        'time'     => 0,
                    ],
                ],
                'tip_da' => 'Prøv at sænke vandtemperaturen til 80°C for en mildere, mere frugtagtig kop. Aeropress er fantastisk til at eksperimentere.',
            ...
            'frenchpress' => [
                ...
                'params' => [
                    ...
                    [ 'value' => 'Grov',     'da' => 'Kværning',   'en' => 'Grind' ],
                ...
                'steps' => [
                    [
                        'title_da' => 'Forvarm',
                        'title_en' => 'Preheat',
                        'desc_da'  => 'Skyl French Press med varmt vand for at forvarme. Tøm vandet.',
                    ...
                    [
                        'title_da' => 'Tilføj kaffe og vand',
                        'title_en' => 'Add coffee and water',
                        'desc_da'  => 'Mal 30g kaffe (grov). Hæld 450g vand (93-96°C) over kaffen.',
                    ...
                    [
                        'title_da' => 'Steep',
                        'title_en' => 'Steep',
                        'desc_da'  => 'Læg låget på uden at trykke stemplet ned. Lad trække i 4 minutter.',
                    ...
                    [
                        ...
                        'desc_da'  => 'Fjern låget. Bryd skorpen på overfladen med en ske og skum af.',
                    ...
                    [
                        ...
                        'desc_da'  => 'Sæt låget på og tryk stemplet langsomt ned. Skænk med det samme.',
    ...
    public static function get_profile() {
        return [
            'details' => [
                ...
                [ 'da' => 'Fermentering',  'en' => 'Fermentation',  'value_da' => 'Anaerobisk', 'value_en' => 'Anaerobic' ],
                [ 'da' => 'Højde',         'en' => 'Altitude',      'value' => '1.600-1.900 m' ],
                [ 'da' => 'Ristet',        'en' => 'Roasted',       'value_da' => 'Elektrisk i København', 'value_en' => 'Electric in Copenhagen' ],
            ],
    ...
    public static function get_guides() {
        return [
            [
                'url'  => '/da/guides/komplet-guide-til-kaffekvaerning-2026/',
                'url_en' => '/en/guides/complete-coffee-grinding-guide-2026/',
                'title_da' => 'Kaffekværning',
                'title_en' => 'Coffee grinding',
                'desc_da'  => 'Komplet guide til kværning, burrs og teknik',
            ...
            [
                'url'  => '/da/guides/espresso/',
                'url_en' => '/en/guides/espresso/',
                'title_da' => 'Espresso',
                'title_en' => 'Espresso',
            ...
            [
                'url'  => '/da/guides/pour-over/',
                'url_en' => '/en/guides/pour-over/',
                'title_da' => 'Pour Over',
                'title_en' => 'Pour Over',
            ...
            [
                'url'  => '/da/guides/aeropress/',
                'url_en' => '/en/guides/aeropress/',
                'title_da' => 'Aeropress',
                'title_en' => 'AeroPress',
            ...
            [
                'url'  => '/da/guides/french-press/',
                'url_en' => '/en/guides/french-press/',
            ...
            [
                ...
                'title_en' => 'Our story',
                'desc_da'  => 'Kaffe ristet med hjerte i København',
    ...
    public static function get_strings() {
        return [
            'da' => [
                ...
                'steps_title'   => 'Fremgangsmåde',
                'grind_label'   => 'Kværningsgrad',
                'grind_fine'    => 'Fin',
                'grind_medium'  => 'Medium',
                'grind_coarse'  => 'Grov',
                'pro_tip'       => 'Pro tip',
                'profile_title' => 'Om denne kaffe',
                'guides_title'  => 'Lær mere',
                'footer_text'   => 'Ristet til ordre i København',
