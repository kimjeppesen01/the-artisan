...
<div class="shipmondo-original">
	<div class="shipmondo_service_point_selection selector_type-modal" data-shipping_agent="<?php echo $shippingMethod->getShippingAgent(); ?>" data-shipping_index="<?php echo $index; ?>" data-selected_service_point="<?php echo htmlentities(json_encode($selectedServicePoint), ENT_QUOTES, 'UTF-8'); ?>">
		...
		<?php Plugin::getTemplate('service-point-selection.modal.modal', ['servicePoints' => $servicePoints, 'selectedServicePoint' => $selectedServicePoint]); ?>
