...
use VivaComSmartCheckout\GuzzleHttp\Cookie\CookieJarInterface;
...
use VivaComSmartCheckout\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('cookies must be an instance of VivaComSmartCheckout\\GuzzleHttp\\Cookie\\CookieJarInterface');
                }
