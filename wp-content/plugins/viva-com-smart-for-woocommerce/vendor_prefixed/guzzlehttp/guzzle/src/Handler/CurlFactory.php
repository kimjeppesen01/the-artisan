...
namespace VivaComSmartCheckout\GuzzleHttp\Handler;

use VivaComSmartCheckout\GuzzleHttp\Exception\ConnectException;
use VivaComSmartCheckout\GuzzleHttp\Exception\RequestException;
use VivaComSmartCheckout\GuzzleHttp\Promise as P;
use VivaComSmartCheckout\GuzzleHttp\Promise\FulfilledPromise;
use VivaComSmartCheckout\GuzzleHttp\Promise\PromiseInterface;
use VivaComSmartCheckout\GuzzleHttp\Psr7\LazyOpenStream;
use VivaComSmartCheckout\GuzzleHttp\TransferStats;
use VivaComSmartCheckout\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \VivaComSmartCheckout\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \VivaComSmartCheckout\GuzzleHttp\Psr7\Utils::streamFor($sink);
