...
use VivaComSmartCheckout\GuzzleHttp\Exception\InvalidArgumentException;
use VivaComSmartCheckout\GuzzleHttp\Handler\CurlHandler;
use VivaComSmartCheckout\GuzzleHttp\Handler\CurlMultiHandler;
use VivaComSmartCheckout\GuzzleHttp\Handler\Proxy;
use VivaComSmartCheckout\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \VivaComSmartCheckout\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
