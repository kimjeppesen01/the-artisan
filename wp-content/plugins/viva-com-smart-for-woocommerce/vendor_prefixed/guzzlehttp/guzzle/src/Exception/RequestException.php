...
use VivaComSmartCheckout\GuzzleHttp\BodySummarizer;
use VivaComSmartCheckout\GuzzleHttp\BodySummarizerInterface;
use VivaComSmartCheckout\Psr\Http\Client\RequestExceptionInterface;
